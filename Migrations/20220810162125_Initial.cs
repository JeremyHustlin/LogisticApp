        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Customers_OrderLocations_OrderLocationId",
                        column: x => x.OrderLocationId,
                        principalTable: "OrderLocations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Schedules_OrderLocations_OrderLocationId",
                        column: x => x.OrderLocationId,
                        principalTable: "OrderLocations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VehicleId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    VehicleLocationId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ForWarders_AspNetUsers_DriverId",
                        column: x => x.DriverId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ForWarders_Schedules_ScheduleId",
                        column: x => x.ScheduleId,
                        principalTable: "Schedules",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ForWarders_Vehicles_VehicleId",
                        column: x => x.VehicleId,
                        principalTable: "Vehicles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ForWarders_VehiclesLocations_VehicleLocationId",
                        column: x => x.VehicleLocationId,
                        principalTable: "VehiclesLocations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ForWarderId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Delivers_ForWarders_ForWarderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Customers_OrderLocationId",
                table: "Customers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Delivers_ForWarderId",
                table: "Delivers",
                column: "ForWarderId");

            migrationBuilder.CreateIndex(
                name: "IX_ForWarders_DriverId",
                table: "ForWarders",
                column: "DriverId");

            migrationBuilder.CreateIndex(
                name: "IX_ForWarders_ScheduleId",
                table: "ForWarders",
                column: "ScheduleId");

            migrationBuilder.CreateIndex(
                name: "IX_ForWarders_VehicleId",
                table: "ForWarders",
                column: "VehicleId");

            migrationBuilder.CreateIndex(
                name: "IX_ForWarders_VehicleLocationId",
                table: "ForWarders",
                column: "VehicleLocationId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderLocations_OrderId",
